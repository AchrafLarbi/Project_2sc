...
async def main(video_path):
    ...
    ocr = GeminiOCR(api_key="AIzaSyA-ey2zTapBuUvNCDVaR8YpXfymctSjJ5E", model_name="gemini-1.5-pro")
    ...
    try:
                ...
                for track in tracks:
                    ...
                    if detection_success:
                        ...
                        if (
                            ...
                            out.write(frame)
            # Try to display frame if GUI support is available, otherwise skip
            try:
        ...
        try:
            ...
            # Skip if OpenCV was built without GUI support
            pass
